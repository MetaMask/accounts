...
- Bump `@metamask/keyring-api` from `^23.5.0` to `^23.6.0` ([#9999](https://github.com/MetaMask/accounts/pull/9999))
- Bump `@metamask/keyring-internal-api` from `^11.0.1` to `^11.0.2` ([#9999](https://github.com/MetaMask/accounts/pull/9999))
- Bump `@metamask/keyring-snap-client` from `^9.2.0` to `^9.2.1` ([#9999](https://github.com/MetaMask/accounts/pull/9999))
