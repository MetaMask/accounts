...
- Add `deleteAccounts` method to the v2 `KeyringClient` for deleting multiple accounts via a single RPC call ([#TODO](https://github.com/MetaMask/accounts/pull/TODO))
