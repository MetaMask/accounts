...
- Add `deleteAccounts` method to the v2 `KeyringClient` for deleting multiple accounts via a single RPC call ([#637](https://github.com/MetaMask/accounts/pull/637))
