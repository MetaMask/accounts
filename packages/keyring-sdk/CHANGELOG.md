...
- fix: revert `originMetadata` addition to `EthKeyringV1Adapter` ([#621](https://github.com/MetaMask/accounts/pull/621))
- feat: add `originMetadata` to `submitRequest` ([#615](https://github.com/MetaMask/accounts/pull/615))
