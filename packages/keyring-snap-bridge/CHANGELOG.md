...
- Implement `deleteAccounts` method in `SnapKeyring` for bulk account deletion via the `keyring_deleteAccounts` RPC method ([#TODO](https://github.com/MetaMask/accounts/pull/TODO))
