...
- feat(keyring-snap-bridge): add `setSelectedAccount` internal option ([#257](https://github.com/MetaMask/accounts.git/pull/257))
- feat!: add `SnapKeyring.createAccount` + internal options ([#252](https://github.com/MetaMask/accounts.git/pull/252))
...
[Unreleased]: https://github.com/MetaMask/accounts.git/compare/@metamask/eth-snap-keyring@12.0.0...HEAD
