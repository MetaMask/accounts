...
- Add `toAccountsFailures` helper for collecting failures from `Promise.allSettled` results keyed by account ID ([#637](https://github.com/MetaMask/accounts/pull/637))
