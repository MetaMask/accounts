import { isCaipAssetId, isCaipAssetType, isCaipChainId } from './caip';

describe('isCaipChainId', () => {
  // Imported from: https://github.com/ChainAgnostic/CAIPs/blob/main/CAIPs/caip-2.md#test-cases
  it.each([
    'eip155:1',
  ...
  ])('returns true for a valid chain id %s', (id) => {
