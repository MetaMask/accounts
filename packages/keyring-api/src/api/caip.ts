...
import type { CaipChainId, CaipAssetId, CaipAssetType } from '@metamask/utils';
import {
  CAIP_CHAIN_ID_REGEX,
...
/**
 * A CAIP-2 chain ID, i.e., a human-readable agnostic chain ID.
 */
export const CaipChainIdStruct = definePattern<CaipChainId>(
  'CaipChainId',
  CAIP_CHAIN_ID_REGEX,
);
export type { CaipChainId };
export { isCaipChainId };
